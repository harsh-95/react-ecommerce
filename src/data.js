...
export const storeProducts = [
  {
    ...
    company: "GOOGLE",
    info:
      "Google Pixel smartphone was launched in October 2016. The phone comes with a 5.00-inch touchscreen display with a resolution of 1080x1920 pixels at a pixel density of 441 pixels per inch (ppi).Google Pixel is powered by a 1.6GHz quad-core Qualcomm Snapdragon 821 processor. It comes with 4GB of RAM.The Google Pixel runs Android 7.1 and is powered by a 2770mAh non-removable battery..",
    inCart: false,
    count: 0,
    total: 0
  },
  ...
  },
  {
    ...
    company: "htc",
    info:
      "HTC Desire 626 smartphone was launched in February 2015. The phone comes with a 5.00-inch touchscreen display with a resolution of 720x1280 pixels at a pixel density of 294 pixels per inch (ppi). HTC Desire 626 is powered by a 1.2GHz quad-core Qualcomm Snapdragon 410 processor. It comes with 1GB of RAM. The HTC Desire 626 runs Android and is powered by a 2000mAh non-removable battery.",
    inCart: false,
    count: 0,
    total: 0
  },
  {
    ...
    company: "apple",
    info:
      "Apple iPhone smartphone was launched in June 2007. The phone comes with a 3.50-inch display with a resolution of 320x480 pixels.Apple iPhone is powered by a 412 MHz one-core processor. It comes with 128MB of RAM. As far as the cameras are concerned, the Apple iPhone on the rear packs 2-megapixel camera.Apple iPhone based on iOS 3 and packs 4GB of inbuilt storage. The Apple iPhone is a single SIM (GSM) smartphone that accepts a Regular-SIM card.Connectivity options on the Apple iPhone include Wi-Fi. Sensors on the phone include accelerometer, ambient light sensor, barometer, gyroscope, proximity sensor, and compass/ magnetometer.The Apple iPhone measures 115.00 x 61.00 x 11.60mm (height x width x thickness) .As of 19th February 2020, Apple iPhone price in India starts at Rs. 10,850. read more",
    inCart: false,
    count: 0,
    total: 0
  },
